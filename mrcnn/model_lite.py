...
class PyramidROIAlign(KE.Layer):
    ...
    def call(self, inputs):
        ...
        ###################################
        # sorting_tensor uses the original indexes.
        # Sorting it gives us the original order from
...
class MaskRCNN():
    ...
    def build_shortcut(self, mode, config):
        ...
        # Detections
        # output [batch, num_detections, (y1, x1, y2, x2, class_id, score)] in
        # normalized coordinates
        detections = DetectionLayer(config, name="mrcnn_detection")(
